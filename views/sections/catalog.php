        ...
        <div class="row">
            ...
            foreach ($catalog as $item) {
                echo
                    ...
                    . '<div class="img img-video" style="background-image:url(' . $item['min_image_video'] . ');" data-src="' . $item['video_link'] . '"></div>'
                    . '</div>'
                    . '<div class="info-car">'
                    ...
                    . '<a href="#" class="btn btn-dark btn-more">Взять в аренду</a>'
                    . '</div>'
                    . '</div>'
                    . '</div>';
            }
